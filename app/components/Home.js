          ...
          <div className="bg-[#141A30] rounded-3xl p-4 flex flex-col gap-2">
            ...
            <div className="flex gap-2 mt-2">
              ...
              <div className={ `${relayStatus === 'ON' ? 'justify-end':'justify-between'} flex-1 bg-[#0F1727] rounded-2xl flex items-center justify-between px-2 `}>
                <div className={`${relayStatus === 'ON'?'bg-green-400 ':'bg-[#EF6060]'} w-[40%] h-[70%] flex items-center justify-center font-bold text-black rounded-full text-xl cursor-pointer mr-4`} onClick={handlePost}>{relayStatus==='ON' ? 'ON':'OFF'}</div>
